...
export default function ProfilePage() {
  ...
  const handleProfileUpdate = (updatedProfile: any) => {
    ...
    const newProfile = {
      ...
      avatar: updatedProfile.avatar ? URL.createObjectURL(updatedProfile.avatar) : userProfile.avatar,
      banner: updatedProfile.banner ? URL.createObjectURL(updatedProfile.banner) : userProfile.banner,
    }
    ...
    <>
      ...
      <div className="relative">
        <div className="relative h-48 w-full overflow-hidden rounded-lg bg-muted sm:h-64">
          <Image src={userProfile.banner || "/placeholder.svg"} alt="Profile banner" fill className="object-cover" />
        </div>
        ...
        <div className="relative mx-4 -mt-12 flex flex-col items-start sm:-mt-16 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="mt-4 flex w-full justify-end sm:mt-0 sm:w-auto">
            ...
            <Button variant="outline" size="icon" className="ml-2" onClick={() => setIsEditProfileOpen(true)}>
